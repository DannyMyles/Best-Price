...
const slides: Slide[] = [
  {
    eyebrow: "Genuine devices · countrywide delivery",
    title: "The tech you want,\nat the best price.",
    subtitle:
      "MacBooks, iPads, iMacs and Surface devices — paid securely on M-Pesa and delivered anywhere in Kenya.",
  ...
  },
  {
    ...
    title: "MacBook Pro.\nSerious power.",
    subtitle:
      "Pro performance for creative and professional workflows — with warranty and support you can count on.",
  ...
  },
  {
    ...
    subtitle:
      "A stunning display and blazing performance make this the most capable iPad yet.",
    cta: "Shop iPad",
